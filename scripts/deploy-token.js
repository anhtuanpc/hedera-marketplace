...
async function main() {
  ...
  const TokenContract = await ethers.getContractFactory("Token", wallet);
  ...
  const contractAddress = (await tokenContract.deployTransaction.wait())
    .contractAddress;

  console.log(`TokenContract deployed to: ${contractAddress}`);
